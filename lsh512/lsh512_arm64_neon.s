...
DATA ·lCPI1_0<>+0x000(SB)/8, $0x0
DATA ·lCPI1_0<>+0x008(SB)/8, $0x10

DATA ·lCPI1_0<>+0x010(SB)/8, $0xffffffffffffffc0
DATA ·lCPI1_0<>+0x018(SB)/8, $0xffffffffffffffd0

DATA ·lCPI1_0<>+0x020(SB)/8, $0x20
DATA ·lCPI1_0<>+0x028(SB)/8, $0x30

DATA ·lCPI1_0<>+0x030(SB)/8, $0xffffffffffffffe0
DATA ·lCPI1_0<>+0x038(SB)/8, $0xfffffffffffffff0

DATA ·lCPI1_0<>+0x040(SB)/8, $0x8
DATA ·lCPI1_0<>+0x048(SB)/8, $0x18

DATA ·lCPI1_0<>+0x050(SB)/8, $0xffffffffffffffc8
DATA ·lCPI1_0<>+0x058(SB)/8, $0xffffffffffffffd8

DATA ·lCPI1_0<>+0x060(SB)/8, $0x28
DATA ·lCPI1_0<>+0x068(SB)/8, $0x38

DATA ·lCPI1_0<>+0x070(SB)/8, $0xffffffffffffffe8
...
LBB1_8:								// LBB1_8:
	MOVD	$·lCPI1_0<>(SB), R9			//     adrp	x9, lCPI1_0@PAGE
										...
										//     adrp	x15, lCPI1_6@PAGE
										//     adrp	x16, lCPI1_7@PAGE
	MOVD	·step+0(SB), R8				//     adrp	x8, _STEP512@PAGE
										//     add	x8, x8, _STEP512@PAGEOFF
	CBZ		R3, LBB1_18					//     cbz	w3, LBB1_18
										// ; %bb.9:
...
LBB1_15:								// LBB1_15:
	...
	FMOVQ	0x10(R9), F6				//     ldr	q6, [x10, lCPI1_1@PAGEOFF]
	WORD	$0x3d801be6					//     str	q6, [sp, #96]                   ; 16-byte Folded Spill
	FMOVQ	0x20(R9), F6				//     ldr	q6, [x11, lCPI1_2@PAGEOFF]
	WORD	$0x3d8017e6					//     str	q6, [sp, #80]                   ; 16-byte Folded Spill
	FMOVQ	0x30(R9), F6				//     ldr	q6, [x12, lCPI1_3@PAGEOFF]
	WORD	$0x3d8013e6					//     str	q6, [sp, #64]                   ; 16-byte Folded Spill
	FMOVQ	0x40(R9), F6				//     ldr	q6, [x13, lCPI1_4@PAGEOFF]
	WORD	$0x3d800fe6					//     str	q6, [sp, #48]                   ; 16-byte Folded Spill
	FMOVQ	0x50(R9), F0				//     ldr	q0, [x14, lCPI1_5@PAGEOFF]
	WORD	$0x3d800be0					//     str	q0, [sp, #32]                   ; 16-byte Folded Spill
	FMOVQ	0x60(R9), F0				//     ldr	q0, [x15, lCPI1_6@PAGEOFF]
	WORD	$0x3d8007e0					//     str	q0, [sp, #16]                   ; 16-byte Folded Spill
	FMOVQ	0x70(R9), F0				//     ldr	q0, [x16, lCPI1_7@PAGEOFF]
...
LBB1_18:								// LBB1_18:
	...
	FMOVQ	0x00(R9), F2				//     ldr	q2, [x9, lCPI1_0@PAGEOFF]
	FMOVQ	0x10(R9), F3				//     ldr	q3, [x10, lCPI1_1@PAGEOFF]
	FMOVQ	0x20(R9), F4				//     ldr	q4, [x11, lCPI1_2@PAGEOFF]
	FMOVQ	0x30(R9), F5				//     ldr	q5, [x12, lCPI1_3@PAGEOFF]
	FMOVQ	0x40(R9), F6				//     ldr	q6, [x13, lCPI1_4@PAGEOFF]
	FMOVQ	0x50(R9), F7				//     ldr	q7, [x14, lCPI1_5@PAGEOFF]
	FMOVQ	0x60(R9), F16				//     ldr	q16, [x15, lCPI1_6@PAGEOFF]
	FMOVQ	0x70(R9), F17				//     ldr	q17, [x16, lCPI1_7@PAGEOFF]
...
LBB2_14:								// LBB2_14:
	...
	FMOVQ	0x00(R9), F6				//     ldr	q6, [x9, lCPI2_0@PAGEOFF]
	WORD	$0x3d801fe6					//     str	q6, [sp, #112]                  ; 16-byte Folded Spill
										//     adrp	x9, lCPI2_1@PAGE
	FMOVQ	0x10(R9), F6				//     ldr	q6, [x9, lCPI2_1@PAGEOFF]
	WORD	$0x3d801be6					//     str	q6, [sp, #96]                   ; 16-byte Folded Spill
										//     adrp	x9, lCPI2_2@PAGE
	FMOVQ	0x20(R9), F6				//     ldr	q6, [x9, lCPI2_2@PAGEOFF]
	WORD	$0x3d8017e6					//     str	q6, [sp, #80]                   ; 16-byte Folded Spill
										//     adrp	x9, lCPI2_3@PAGE
	FMOVQ	0x30(R9), F6				//     ldr	q6, [x9, lCPI2_3@PAGEOFF]
	WORD	$0x3d8013e6					//     str	q6, [sp, #64]                   ; 16-byte Folded Spill
										//     adrp	x9, lCPI2_4@PAGE
	FMOVQ	0x40(R9), F6				//     ldr	q6, [x9, lCPI2_4@PAGEOFF]
	WORD	$0x3d800fe6					//     str	q6, [sp, #48]                   ; 16-byte Folded Spill
										//     adrp	x9, lCPI2_5@PAGE
	FMOVQ	0x50(R9), F0				//     ldr	q0, [x9, lCPI2_5@PAGEOFF]
	WORD	$0x3d800be0					//     str	q0, [sp, #32]                   ; 16-byte Folded Spill
										//     adrp	x9, lCPI2_6@PAGE
	FMOVQ	0x60(R9), F0				//     ldr	q0, [x9, lCPI2_6@PAGEOFF]
	WORD	$0x3d8007e0					//     str	q0, [sp, #16]                   ; 16-byte Folded Spill
										//     adrp	x9, lCPI2_7@PAGE
	FMOVQ	0x70(R9), F0				//     ldr	q0, [x9, lCPI2_7@PAGEOFF]
	WORD	$0x3d8003e0					//     str	q0, [sp]                        ; 16-byte Folded Spill
	MOVD	·step(SB), R9				//     adrp	x9, _STEP512@PAGE
										//     add	x9, x9, _STEP512@PAGEOFF
