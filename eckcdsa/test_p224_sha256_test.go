...
// something is weird
func Test_Testcase_P224_SHA256(t *testing.T) {
	testVerify(t, testCases_P224_SHA256)
}

var (
	testCases_P224_SHA256 = []testCase{
		////////////////////////////////////////////////////////////////////////////////////////////////////
		// EC-KCDSA_(P-224)(SHA-256)_SGT.txt
		{
			...
			S:     internal.HI(`88C16B91EA4265ACDC0C27DCA47AF42035D00B07A196D91D2ED41A67043B7961`),
			R:     internal.HI(`9A81C7738DE9E7D8FFBFE7BA97B0101E296EC2F3C52E71C908EF9017`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`B1F05010AED4CAFB46684190F94BB02777F3ED35FA99FA7567BEAA5DA7DEAF7A`),
			R:     internal.HI(`469F6EC475579860496DEDECF3A2AB3A78010A320953CD385DA530D0`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`2DB648E69439E8D7EC07F339938B6FDF0CE79F3113ACFFEE8CD3AE035D731544`),
			R:     internal.HI(`AC996076CCEEB5D8F2E3BBD88E4F58321A6AEFCF499BC5EC47BDB624`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`527DCA791D017A41891C1CF2A654F993F8C916BB078071499C60A12C4E0EEE7A`),
			R:     internal.HI(`487B34EFFF81A2E066D272FED7CE83FDC172DA53A22A41EFA9DC4C95`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`CF9E535C047C24F8FC7B88F46086BBFF9B9239BA2235D833DFE9BBBC72573F29`),
			R:     internal.HI(`709D4EA896C9A752CC91209BBB3DC1D70B9323C6D8F9960C9651636F`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`0806146AC8DFE3057B6D301C2AC499ED0D09277EF0CD42AFD8530DDF6BE2004F`),
			R:     internal.HI(`E1896FD0036C5F0FFC6C8CFEFD532397F1BCF4BB3ADE93146F9964E3`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`97AB6BE0F3AB4B10AEC73596ADDDB658B69296C04CB906CFE28277A9297F9CAD`),
			R:     internal.HI(`6884D3B984D052EC2B664152D0140A4814EF7BE2DA906D5299F5B76F`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`C7ED3E05DF2D578D0C0EB3D194CEC1A69C85BF8F4CD303EEDAA5FDD7BD51B214`),
			R:     internal.HI(`E6A2348F7266F290B70B11908F532DC289773A39799C1C530B12ECBB`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`3CCBF932688CCDBB34E2F69FD2E49074BC1E34F86C77BAB00BE970FE7E310034`),
			R:     internal.HI(`CDB3802240DA809E6B53B4E3DA524F5CA74197012C121A3A1DC151B2`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`DC6069B3360962D085F4EDDBDA37E530673E80802578C53735B5E45655530985`),
			R:     internal.HI(`18475B2A0E55D692B8E60D9BC72BBFA6B7406A903B346061541C7C9C`),
		},
		////////////////////////////////////////////////////////////////////////////////////////////////////
		// EC-KCDSA_(P-224)(SHA-256)_SVT.txt
		{
			...
			S:     internal.HI(`65353BB7BDFB3A59D403EF1A59D6936E93F759D7EF17CDE6FAA088A47DD9DDC5`),
			R:     internal.HI(`C65C240F8F6115CD612A40727F76E83E63B0713BB201E050D2E0A39B`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`E82127B8DA7E054B392E3451034FF811E85F5694673DF00310B1BD0BCC827EC9`),
			R:     internal.HI(`09121E872738C5D1DD4CE4BC30B021E7F72D125A8938453A81A0E7DF`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`452B9C243C5F4C867EB3EF081E0A23DAAF8E4959B97AA6B1876DA389445B17B8`),
			R:     internal.HI(`834C945368AFB414E79C3C0D901D45E582C31C569A13B538A16454E9`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`CBB7784EA4DD67442FF3155C7C6CE1E4F4C5DC3EFA69B93AE6FD07426A1B5A9C`),
			R:     internal.HI(`427E612C373464F490B4CE0633A6743DEEBFDF335D08DD6DE8132B0C`),
			Fail:  true,
		},
		{
			curve: p224,
			...
			S:     internal.HI(`5ABBA3076EAFB1AACF9A4A5A3AF8DE7D1B845CD42C6029EFC0F0E68C3B1164C3`),
			R:     internal.HI(`15FAE9C5B0CB355D4D4C0CB8413B61BD1FAB1D0F3E45FC824F29DC3C`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`68129233E06FE26AA3BB35108F783B3210089349C18472345F3A0B5419BDB664`),
			R:     internal.HI(`209D9DEAC7F3CEDFEBBEF288E9C098A9CDA1DBA898F945430A5456BA`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`DFE04785116A4ADB75C00AEF2D63A2E6BFFD104E989AF90EFCDF4CDBA4425335`),
			R:     internal.HI(`FD836D9261D90FB52DF9857BA0B4548E7168C5A7DD28A0C413F963D5`),
			Fail:  true,
		},
		{
			curve: p224,
			...
			S:     internal.HI(`BCA234ED76FD37AE80FF36EFB4EB3B74E39EDFDAAE82A652375B02037B87BCCD`),
			R:     internal.HI(`5606A7B5EB6B0C154769CFB0172D5720A4BCA99884F50D0D14AD5376`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`910926A8F20D8A217A35E96F5AA2974C968027154A27A7FD6F6CC54681D727CB`),
			R:     internal.HI(`C3C64DCC32644A8A953465F2E099DF2E0BABC0C7DD6CC95D8C717A2C`),
			Fail:  true,
		},
		{
			curve: p224,
			...
			S:     internal.HI(`5E6FCA7C5BBBEEC4996F9C457F0E162819364A8EC5BB32A0C3F8AF655030F663`),
			R:     internal.HI(`83BF870BAABB26B22AEFC6942FCE657BAB08FAF5A98EC54490A73C7C`),
		},
		{
			curve: p224,
			hash:  hashSHA256,
			...
			S:     internal.HI(`BD8A7B2E3EFF25BC6776D7626C791FA5CC1FAC056B553B84ACF5A774D08E842A`),
			R:     internal.HI(`B2740E187A866EDC41F6CFC9FBDB671EF33905B25778BC8533450A77`),
		},
	}
)
