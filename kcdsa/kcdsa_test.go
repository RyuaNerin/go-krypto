...
var (
	...
	testCases = []struct {
		...
		// Ⅱ.1 소수 p, q의 길이 (α, β) = (2048, 224), SHA-224 적용 예
		{
			...
			Seed_: pb_(`c0 52 a2 76 41 00 f0 f4 ec 90 6b 9c 5c 6b 10 6e 34 70 df c1 36 9f
						12 c0 62 f8 0e e9`),
			J: hi_(`870145cb 93f25fb2 9509261c 4510929e b5451582 b0fede90 54a45927 2b87bd40
			...
			H: pb_(`8cd78a90 87aca828 9c0f5422 1e008eaa f46c56c0 581ea864 4a5e31a0 ca2c4805
			...
			XKEY: pb_(`f910456a 20d9ba54 d61495ea 046d5de1 4b90ffdf eff64b4c a89150be`),
			...
			Z: hi_(`1b d0 c0 f0 e0 7c b5 f1 ee 4f f4 05 23 59 1f 17 8a 4f c7 cb 50 65 f6 a3
					82 16 e9 a0 99 c2 05 b2 9b 87 46 d8 65 e1 af 6d 90 3e 5a 13 80 04 91 0b
					70 eb 5b 84 ee d9 76 0e a6 05 78 bf 08 85 28 98`),

			KKEY: hi_(`49561994 fd2bad5e 410ca1c1 5c3fd3f1 2e70263f 2820ad5c 566ded80`),
		...
		// Ⅱ.2 소수 p, q의 길이 (α, β) = (2048, 224), SHA-256 적용 예
		{
			...
			Seed_: pb_(`e1 75 ca d0 ea cb 74 dd b4 5f 15 f1 f2 57 22 bf 15 56 ef 86 0a 0f e0
						31 71 18 44 9b`),
			J: hi_(`853cd825 d245b074 cbc4f83d f6a9f182 4591223b ef5aafe9 5b0c14fc 6e63fc86
			...
			Z: hi_(`c4 d8 33 b5 d0 69 20 2a 96 8f 3a c3 5f a7 7b af bd d9 c0 96 07 52 c5 da
					f7 83 92 9d e2 da d9 16 f1 15 9e 75 a3 45 44 5d 63 c5 b4 22 e0 bc d2 ba
					d9 37 9d 14 43 89 2e d5 d1 2f 82 85 3d 51 a7 05`),

			KKEY: hi_(`a5c22f64 dde15693 3ad15bcb 928d6a3b 5acf0d7a 2302615c e74ccad6`),
		...
		// Ⅱ.3 소수 p, q의 길이 (α, β) = (2048, 256), SHA-256 적용 예
		{
			...
			Seed_: pb_(`f7 5a bd a0 03 2c e2 18 ce 04 ba f0 a6 dc 92 c8 7e b4 6a a0 56 8c 42
						78 2e 64 4c c2 b8 2e 24 9a`),
			J: hi_(`804e0d9f 553ee7d2 3d093a41 cfdc7ef9 cc389257 f6a67cfc 392e06b9 b292899c
			...
			H: pb_(`cfbaee38 b256284b cd948b7d cc4bad84 8bc4908c 3c901434 101cac10 bd2b840d
			...
			XKEY: pb_(`f0f30814 a667cf10 587274d3 3bf2ab78 8b904cf1 2e97da0b c0a936e2 b948da94`),
			...
			Z: hi_(`7f f4 05 82 ae 33 d8 db f3 77 a7 61 9a d1 c0 06 68 63 37 79 29 43 e6 cd
					01 6d 55 34 e4 12 2b ca 18 d1 20 75 79 ea 4c 90 61 0a 14 96 b6 3c 23 dc
					99 6b 68 6e fe b3 4c 36 1f 9a fd cf 7e 8f bf 9a`),

			KKEY: hi_(`0d30f8f9 2313f7a5 abe0b0de ec219e40 c4640c89 39222aa0 dd6a3329 55778025`),
		...
		// Ⅱ.4 소수 p, q의 길이 (α, β) = (3072, 256), SHA-256 적용 예
		{
			...
			Seed_: pb_(`b8 56 20 16 38 55 a7 c0 05 76 13 dc d1 f2 ae 61 80 c4 34 d0 98 90 ea
						70 22 00 83 f2 8d 27 54 ad`),
			J: hi_(`85eee24d 8bc775c7 adab8963 9c4013f6 ad8f98c8 350bcd4d db7ed3ca 1e56bd46
			...
			H: pb_(`cafddcde a0226466 28aaec4c f61afea2 062a0eb2 d5cb81fc 02c84e94 9a60d8f0
			...
			XKEY: pb_(`80f96d39 d9e9230d 47c7ac5b c40e94d7 c3ca4c8e fa2bb0cd f1a369ab 14dfce52`),
			...
			Y: hi_(`2574e10e 806f1c42 58f7cf8f a4a6cf2b eb177dbe 60e4ec17 df21dcdb a72073f6
					...
					ea0a3a2a 617661c1 6a372fe0 58b547a2 8b626ecf 442222e1 8eef487c c101dbfbs
					715bc33a b85928ec f0bd4dea 30f250a6 a5c86178 83ea0f87 3e7a4651 98c4644b`),
			Z: hi_(`ea 0a 3a 2a 61 76 61 c1 6a 37 2f e0 58 b5 47 a2 8b 62 6e cf 44 22 22 e1
					8e ef 48 7c c1 01 db fb 71 5b c3 3a b8 59 28 ec f0 bd 4d ea 30 f2 50 a6
					a5 c8 61 78 83 ea 0f 87 3e 7a 46 51 98 c4 64 4b`),

			KKEY: hi_(`83f3008f cebae57e c7a64a3a f7ee6ee1 9cc197a6 d5eba3a5 b3ef79b2 f8f3dd53`),
...
func TestSignAndVerify(t *testing.T) {
	for _, tc := range testCases {
		...
		R, S, err := SignWithK(tc.KKEY, &key, bytes.NewReader(M))
		if err != nil {
			t.Error(err)
		}
		...
		ok, _ := Verify(&key.PublicKey, bytes.NewReader(M), tc.R, tc.S)
		if !ok {
...
func TestSignAndVerifyWithBadPublicKey(t *testing.T) {
	for idx, tc := range testCases {
		...
		ok, _ := Verify(&key, bytes.NewReader(M), tc.R, tc.S)
		if ok {
