...
var (
	sizeDSA2KCDSA = map[dsa.ParameterSizes]kcdsa.ParameterSizes{
		dsa.L2048N224: kcdsa.L2048N224SHA224,
		dsa.L2048N256: kcdsa.L2048N256SHA256,
		dsa.L3072N256: kcdsa.L3072N256SHA256,
	}
)
...
func Test_KCDSA_TO_DSA(t *testing.T) {
	for _, sz := range sizeDSA2KCDSA {
		...
		GenerateKey(&expect, rand.Reader, UserProvidedRandomInput, sz)
