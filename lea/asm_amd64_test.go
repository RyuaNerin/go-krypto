...
var (
	leaEnc4SSE2 = toAsmFunc(__lea_encrypt_4block)
	leaDec4SSE2 = toAsmFunc(__lea_decrypt_4block)

	leaEnc8AVX2 = toAsmFunc(__lea_encrypt_8block)
	leaDec8AVX2 = toAsmFunc(__lea_decrypt_8block)
)
