...
func leaEnc8AVX2() {
	TEXT("leaEnc8AVX2", NOSPLIT, "func(round int, rk []uint32, dst []byte, src []byte)")

	round := Load(Param("round"), GP64())
	...
	*/
	...
	XAR3_AVX2(rk, x3, x2, 4, 5)
	XAR5_AVX2(rk, x2, x1, 2, 3)
	XAR9_AVX2(rk, x1, x0, 0, 1)
	XAR3_AVX2(rk, x0, x3, 10, 11)
	XAR5_AVX2(rk, x3, x2, 8, 9)
	XAR9_AVX2(rk, x2, x1, 6, 7)
	XAR3_AVX2(rk, x1, x0, 16, 17)
	XAR5_AVX2(rk, x0, x3, 14, 15)
	XAR9_AVX2(rk, x3, x2, 12, 13)
	XAR3_AVX2(rk, x2, x1, 22, 23)
	XAR5_AVX2(rk, x1, x0, 20, 21)
	XAR9_AVX2(rk, x0, x3, 18, 19)

	XAR3_AVX2(rk, x3, x2, 28, 29)
	XAR5_AVX2(rk, x2, x1, 26, 27)
	XAR9_AVX2(rk, x1, x0, 24, 25)
	XAR3_AVX2(rk, x0, x3, 34, 35)
	XAR5_AVX2(rk, x3, x2, 32, 33)
	XAR9_AVX2(rk, x2, x1, 30, 31)
	XAR3_AVX2(rk, x1, x0, 40, 41)
	XAR5_AVX2(rk, x0, x3, 38, 39)
	XAR9_AVX2(rk, x3, x2, 36, 37)
	XAR3_AVX2(rk, x2, x1, 46, 47)
	XAR5_AVX2(rk, x1, x0, 44, 45)
	XAR9_AVX2(rk, x0, x3, 42, 43)

	XAR3_AVX2(rk, x3, x2, 52, 53)
	XAR5_AVX2(rk, x2, x1, 50, 51)
	XAR9_AVX2(rk, x1, x0, 48, 49)
	XAR3_AVX2(rk, x0, x3, 58, 59)
	XAR5_AVX2(rk, x3, x2, 56, 57)
	XAR9_AVX2(rk, x2, x1, 54, 55)
	XAR3_AVX2(rk, x1, x0, 64, 65)
	XAR5_AVX2(rk, x0, x3, 62, 63)
	XAR9_AVX2(rk, x3, x2, 60, 61)
	XAR3_AVX2(rk, x2, x1, 70, 71)
	XAR5_AVX2(rk, x1, x0, 68, 69)
	XAR9_AVX2(rk, x0, x3, 66, 67)

	XAR3_AVX2(rk, x3, x2, 76, 77)
	XAR5_AVX2(rk, x2, x1, 74, 75)
	XAR9_AVX2(rk, x1, x0, 72, 73)
	XAR3_AVX2(rk, x0, x3, 82, 83)
	XAR5_AVX2(rk, x3, x2, 80, 81)
	XAR9_AVX2(rk, x2, x1, 78, 79)
	XAR3_AVX2(rk, x1, x0, 88, 89)
	XAR5_AVX2(rk, x0, x3, 86, 87)
	XAR9_AVX2(rk, x3, x2, 84, 85)
	XAR3_AVX2(rk, x2, x1, 94, 95)
	XAR5_AVX2(rk, x1, x0, 92, 93)
	XAR9_AVX2(rk, x0, x3, 90, 91)

	XAR3_AVX2(rk, x3, x2, 100, 101)
	XAR5_AVX2(rk, x2, x1, 98, 99)
	XAR9_AVX2(rk, x1, x0, 96, 97)
	XAR3_AVX2(rk, x0, x3, 106, 107)
	XAR5_AVX2(rk, x3, x2, 104, 105)
	XAR9_AVX2(rk, x2, x1, 102, 103)
	XAR3_AVX2(rk, x1, x0, 112, 113)
	XAR5_AVX2(rk, x0, x3, 110, 111)
	XAR9_AVX2(rk, x3, x2, 108, 109)
	XAR3_AVX2(rk, x2, x1, 118, 119)
	XAR5_AVX2(rk, x1, x0, 116, 117)
	XAR9_AVX2(rk, x0, x3, 114, 115)

	XAR3_AVX2(rk, x3, x2, 124, 125)
	XAR5_AVX2(rk, x2, x1, 122, 123)
	XAR9_AVX2(rk, x1, x0, 120, 121)
	XAR3_AVX2(rk, x0, x3, 130, 131)
	XAR5_AVX2(rk, x3, x2, 128, 129)
	XAR9_AVX2(rk, x2, x1, 126, 127)
	XAR3_AVX2(rk, x1, x0, 136, 137)
	XAR5_AVX2(rk, x0, x3, 134, 135)
	XAR9_AVX2(rk, x3, x2, 132, 133)
	XAR3_AVX2(rk, x2, x1, 142, 143)
	XAR5_AVX2(rk, x1, x0, 140, 141)
	XAR9_AVX2(rk, x0, x3, 138, 139)

	CMPQ(round, U32(24))
	JBE(LabelRef("OVER24_END"))
	XAR3_AVX2(rk, x3, x2, 148, 149)
	XAR5_AVX2(rk, x2, x1, 146, 147)
	XAR9_AVX2(rk, x1, x0, 144, 145)
	XAR3_AVX2(rk, x0, x3, 154, 155)
	XAR5_AVX2(rk, x3, x2, 152, 153)
	XAR9_AVX2(rk, x2, x1, 150, 151)
	XAR3_AVX2(rk, x1, x0, 160, 161)
	XAR5_AVX2(rk, x0, x3, 158, 159)
	XAR9_AVX2(rk, x3, x2, 156, 157)
	XAR3_AVX2(rk, x2, x1, 166, 167)
	XAR5_AVX2(rk, x1, x0, 164, 165)
	XAR9_AVX2(rk, x0, x3, 162, 163)
	Label("OVER24_END")

	CMPQ(round, U32(28))
	JBE(LabelRef("OVER28_END"))
	XAR3_AVX2(rk, x3, x2, 172, 173)
	XAR5_AVX2(rk, x2, x1, 170, 171)
	XAR9_AVX2(rk, x1, x0, 168, 169)
	XAR3_AVX2(rk, x0, x3, 178, 179)
	XAR5_AVX2(rk, x3, x2, 176, 177)
	XAR9_AVX2(rk, x2, x1, 174, 175)
	XAR3_AVX2(rk, x1, x0, 184, 185)
	XAR5_AVX2(rk, x0, x3, 182, 183)
	XAR9_AVX2(rk, x3, x2, 180, 181)
	XAR3_AVX2(rk, x2, x1, 190, 191)
	XAR5_AVX2(rk, x1, x0, 188, 189)
	XAR9_AVX2(rk, x0, x3, 186, 187)
	Label("OVER28_END")
...
func leaDec8AVX2() {
	TEXT("leaDec8AVX2", NOSPLIT, "func(round int, rk []uint32, dst []byte, src []byte)")
	...
	*/
	...
	CMPQ(round, U32(28))
	JBE(LabelRef("OVER28_END"))
	XSR9_AVX2(rk, x0, x3, 186, 187)
	XSR5_AVX2(rk, x1, x0, 188, 189)
	XSR3_AVX2(rk, x2, x1, 190, 191)
	XSR9_AVX2(rk, x3, x2, 180, 181)
	XSR5_AVX2(rk, x0, x3, 182, 183)
	XSR3_AVX2(rk, x1, x0, 184, 185)
	XSR9_AVX2(rk, x2, x1, 174, 175)
	XSR5_AVX2(rk, x3, x2, 176, 177)
	XSR3_AVX2(rk, x0, x3, 178, 179)
	XSR9_AVX2(rk, x1, x0, 168, 169)
	XSR5_AVX2(rk, x2, x1, 170, 171)
	XSR3_AVX2(rk, x3, x2, 172, 173)
	Label("OVER28_END")

	CMPQ(round, U32(24))
	JBE(LabelRef("OVER24_END"))
	XSR9_AVX2(rk, x0, x3, 162, 163)
	XSR5_AVX2(rk, x1, x0, 164, 165)
	XSR3_AVX2(rk, x2, x1, 166, 167)
	XSR9_AVX2(rk, x3, x2, 156, 157)
	XSR5_AVX2(rk, x0, x3, 158, 159)
	XSR3_AVX2(rk, x1, x0, 160, 161)
	XSR9_AVX2(rk, x2, x1, 150, 151)
	XSR5_AVX2(rk, x3, x2, 152, 153)
	XSR3_AVX2(rk, x0, x3, 154, 155)
	XSR9_AVX2(rk, x1, x0, 144, 145)
	XSR5_AVX2(rk, x2, x1, 146, 147)
	XSR3_AVX2(rk, x3, x2, 148, 149)
	Label("OVER24_END")

	XSR9_AVX2(rk, x0, x3, 138, 139)
	XSR5_AVX2(rk, x1, x0, 140, 141)
	XSR3_AVX2(rk, x2, x1, 142, 143)
	XSR9_AVX2(rk, x3, x2, 132, 133)
	XSR5_AVX2(rk, x0, x3, 134, 135)
	XSR3_AVX2(rk, x1, x0, 136, 137)
	XSR9_AVX2(rk, x2, x1, 126, 127)
	XSR5_AVX2(rk, x3, x2, 128, 129)
	XSR3_AVX2(rk, x0, x3, 130, 131)
	XSR9_AVX2(rk, x1, x0, 120, 121)
	XSR5_AVX2(rk, x2, x1, 122, 123)
	XSR3_AVX2(rk, x3, x2, 124, 125)

	XSR9_AVX2(rk, x0, x3, 114, 115)
	XSR5_AVX2(rk, x1, x0, 116, 117)
	XSR3_AVX2(rk, x2, x1, 118, 119)
	XSR9_AVX2(rk, x3, x2, 108, 109)
	XSR5_AVX2(rk, x0, x3, 110, 111)
	XSR3_AVX2(rk, x1, x0, 112, 113)
	XSR9_AVX2(rk, x2, x1, 102, 103)
	XSR5_AVX2(rk, x3, x2, 104, 105)
	XSR3_AVX2(rk, x0, x3, 106, 107)
	XSR9_AVX2(rk, x1, x0, 96, 97)
	XSR5_AVX2(rk, x2, x1, 98, 99)
	XSR3_AVX2(rk, x3, x2, 100, 101)

	XSR9_AVX2(rk, x0, x3, 90, 91)
	XSR5_AVX2(rk, x1, x0, 92, 93)
	XSR3_AVX2(rk, x2, x1, 94, 95)
	XSR9_AVX2(rk, x3, x2, 84, 85)
	XSR5_AVX2(rk, x0, x3, 86, 87)
	XSR3_AVX2(rk, x1, x0, 88, 89)
	XSR9_AVX2(rk, x2, x1, 78, 79)
	XSR5_AVX2(rk, x3, x2, 80, 81)
	XSR3_AVX2(rk, x0, x3, 82, 83)
	XSR9_AVX2(rk, x1, x0, 72, 73)
	XSR5_AVX2(rk, x2, x1, 74, 75)
	XSR3_AVX2(rk, x3, x2, 76, 77)

	XSR9_AVX2(rk, x0, x3, 66, 67)
	XSR5_AVX2(rk, x1, x0, 68, 69)
	XSR3_AVX2(rk, x2, x1, 70, 71)
	XSR9_AVX2(rk, x3, x2, 60, 61)
	XSR5_AVX2(rk, x0, x3, 62, 63)
	XSR3_AVX2(rk, x1, x0, 64, 65)
	XSR9_AVX2(rk, x2, x1, 54, 55)
	XSR5_AVX2(rk, x3, x2, 56, 57)
	XSR3_AVX2(rk, x0, x3, 58, 59)
	XSR9_AVX2(rk, x1, x0, 48, 49)
	XSR5_AVX2(rk, x2, x1, 50, 51)
	XSR3_AVX2(rk, x3, x2, 52, 53)

	XSR9_AVX2(rk, x0, x3, 42, 43)
	XSR5_AVX2(rk, x1, x0, 44, 45)
	XSR3_AVX2(rk, x2, x1, 46, 47)
	XSR9_AVX2(rk, x3, x2, 36, 37)
	XSR5_AVX2(rk, x0, x3, 38, 39)
	XSR3_AVX2(rk, x1, x0, 40, 41)
	XSR9_AVX2(rk, x2, x1, 30, 31)
	XSR5_AVX2(rk, x3, x2, 32, 33)
	XSR3_AVX2(rk, x0, x3, 34, 35)
	XSR9_AVX2(rk, x1, x0, 24, 25)
	XSR5_AVX2(rk, x2, x1, 26, 27)
	XSR3_AVX2(rk, x3, x2, 28, 29)

	XSR9_AVX2(rk, x0, x3, 18, 19)
	XSR5_AVX2(rk, x1, x0, 20, 21)
	XSR3_AVX2(rk, x2, x1, 22, 23)
	XSR9_AVX2(rk, x3, x2, 12, 13)
	XSR5_AVX2(rk, x0, x3, 14, 15)
	XSR3_AVX2(rk, x1, x0, 16, 17)
	XSR9_AVX2(rk, x2, x1, 6, 7)
	XSR5_AVX2(rk, x3, x2, 8, 9)
	XSR3_AVX2(rk, x0, x3, 10, 11)
	XSR9_AVX2(rk, x1, x0, 0, 1)
	XSR5_AVX2(rk, x2, x1, 2, 3)
	XSR3_AVX2(rk, x3, x2, 4, 5)
...
func XAR_AVX2(rk Mem, cur, pre VecVirtual, rk1, rk2, a, b int) {
	...
	tmp = _mm256_add_epi32(              ----> tmp0
		_mm256_xor_si256(                ------> tmp0
			pre,
			_mm256_set1_epi32(rk1)       --------> tmp0
		),
		_mm256_xor_si256(                ------> tmp1
			cur,
			_mm256_set1_epi32(rk2)       --------> tmp1
		)
	);
	...
	cur = _mm256_xor_si256(                ----> cur
		_mm256_sub_epi32(                  ------> cur
			...
			_mm256_xor_si256(              --------> tmp
				pre,
				_mm256_set1_epi32(rk1)     ----------> tmp
			)
		),
		_mm256_set1_epi32(rk2)             ------> tmp
	);
	*/
