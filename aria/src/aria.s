	...
	.globl	_initEncKey_NEON                ; -- Begin function initEncKey_NEON
	.p2align	2
_initEncKey_NEON:                       ; @initEncKey_NEON
; %bb.0:
	...
	fmov	s0, w16
	mov.s	v0[1], w14
	mov	x9, #274877906816               ; =0x3fffffff80
	add	x4, x2, x9
	lsl	x9, x4, #26
	asr	x9, x9, #32
Lloh0:
...
Lloh9:
	...
	eor	w5, w13, w5
	lsr	w13, w6, #24
	ldr	w20, [x9, w13, uxtw #2]
	ubfx	w13, w6, #16, #8
	ldr	w21, [x10, w13, uxtw #2]
...
LBB0_5:
	...
	eor	w21, w22, w23
	eor	w20, w22, w20
	and	w22, w8, w19, lsl #8
	and	w19, w13, w19, lsr #8
	orr	w19, w22, w19
	ror	w22, w23, #16
	rev	w20, w20
	eor	w20, w20, w21
	...
	ldr	w9, [x9, w3, uxtw #2]
	ubfx	w3, w15, #16, #8
	ldr	w10, [x10, w3, uxtw #2]
	ubfx	w3, w15, #8, #8
	ldr	w11, [x11, w3, uxtw #2]
	eor	w9, w10, w9
	and	w10, w15, #0xff
...
LBB0_8:
	...
	.loh AdrpAdd	Lloh0, Lloh1
                                        ; -- End function
	.globl	_initDecKey_NEON                ; -- Begin function initDecKey_NEON
	.p2align	2
_initDecKey_NEON:                       ; @initDecKey_NEON
; %bb.0:
	mov	w8, #-16711936                  ; =0xff00ff00
	mov	w9, #16711935                   ; =0xff00ff
	lsr	x10, x2, #5
	mov	x11, #137438953472              ; =0x2000000000
	add	x11, x11, x10, lsl #34
	add	x12, x0, x11, asr #30
	ldr	w10, [x12]
	ldr	q0, [x0]
	str	w10, [x0]
	ldr	w10, [x12, #4]
...
LBB1_5:
	...
	ret
                                        ; -- End function
	.globl	_process_NEON                   ; -- Begin function process_NEON
	.p2align	2
_process_NEON:                          ; @process_NEON
; %bb.0:
	stp	x29, x30, [sp, #-16]!           ; 16-byte Folded Spill
	mov	x29, sp
