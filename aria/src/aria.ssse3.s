	...
	.p2align	4, 0x0                          ## -- Begin function Crypt
LCPI0_0:
	.byte	3                               ## 0x3
	.byte	2                               ## 0x2
	.byte	1                               ## 0x1
...
LBB0_5:
	...
	movzx	esi, sil
	mov	r10d, dword ptr [r9 + 4*rsi]
	xor	r10d, dword ptr [r8 + 4*rbx]
	xor	r10d, dword ptr [r12 + 4*rdi]
	xor	r10d, dword ptr [r14 + 4*r13]
	mov	esi, ecx
	movzx	edi, ch
	movzx	r15d, cl
                                        ## kill: def $ecx killed $ecx def $rcx
	...
	xor	ebx, dword ptr [r12 + 4*rdi]
	xor	ebx, dword ptr [r14 + 4*r15]
	mov	ecx, eax
	movzx	esi, ah
	movzx	edi, al
                                        ## kill: def $eax killed $eax def $rax
	...
	xor	ebx, r15d
	xor	r13d, dword ptr [r11 + 40]
	xor	ecx, dword ptr [r11 + 44]
	xor	r13d, r15d
	xor	ecx, edx
	shr	eax, 24
	shr	esi, 16
	movzx	edx, sil
	mov	r15d, dword ptr [r14 + 4*rdx]
	...
	xor	edx, dword ptr [r12 + 4*r10]
	xor	edx, dword ptr [r8 + 4*rsi]
	...
	shr	eax, 16
	movzx	eax, al
	mov	ebx, dword ptr [r14 + 4*rax]
	xor	ebx, dword ptr [r12 + 4*rcx]
	xor	ebx, dword ptr [r8 + 4*rsi]
	mov	r9, r8
	xor	ebx, dword ptr [r13 + 4*rdi]
	mov	r8, r13
	xor	edx, r10d
	...
	bswap	ebx
	xor	eax, ebx
	xor	edx, dword ptr [r11 + 52]
	xor	edx, eax
	xor	eax, dword ptr [r11 + 56]
	xor	ebx, dword ptr [r11 + 60]
	xor	ebx, r10d
	xor	eax, r15d
	shr	ecx, 24
	shr	esi, 16
	...
	shr	ecx, 16
	movzx	ecx, cl
	mov	edx, dword ptr [r8 + 4*rcx]
	xor	edx, dword ptr [r9 + 4*r15]
	xor	edx, dword ptr [r12 + 4*rsi]
	xor	edx, dword ptr [r14 + 4*rdi]
	mov	ecx, eax
	movzx	esi, ah
	...
	ror	ebx, 16
	xor	r15d, ebx
	xor	edx, dword ptr [r11 + 68]
	xor	edx, r15d
	xor	r13d, dword ptr [r11 + 72]
	xor	ecx, dword ptr [r11 + 76]
	xor	r13d, r15d
	xor	ecx, ebx
	shr	eax, 24
	shr	esi, 16
	movzx	esi, sil
	mov	r15d, dword ptr [r14 + 4*rsi]
	mov	r8, r12
	xor	r15d, dword ptr [r12 + 4*rax]
	mov	rbx, r9
	xor	r15d, dword ptr [r9 + 4*rdi]
	lea	r12, [rip + _X2]
	xor	r15d, dword ptr [r12 + 4*r10]
	mov	eax, edx
	movzx	esi, dh
	movzx	edi, dl
	mov	r10d, edx
	...
	bswap	ebx
	xor	eax, ebx
	xor	edx, dword ptr [r11 + 84]
	xor	edx, eax
	xor	eax, dword ptr [r11 + 88]
	xor	ebx, dword ptr [r11 + 92]
	xor	ebx, r10d
	xor	eax, r15d
	shr	ecx, 24
	shr	esi, 16
	...
	ror	ebx, 16
	xor	r15d, ebx
	xor	edx, dword ptr [r11 + 100]
	xor	edx, r15d
	xor	r13d, dword ptr [r11 + 104]
	xor	ecx, dword ptr [r11 + 108]
	xor	r13d, r15d
	xor	ecx, ebx
	shr	eax, 24
	shr	esi, 16
	...
	mov	r15d, dword ptr [r9 + 4*rsi]
	mov	rbx, r8
	xor	r15d, dword ptr [r8 + 4*rax]
	xor	r15d, dword ptr [r12 + 4*rdi]
	mov	r8, r14
	...
	movzx	eax, al
	mov	edx, dword ptr [r9 + 4*rax]
	xor	edx, dword ptr [rbx + 4*r10]
	mov	r14, rbx
	xor	edx, dword ptr [r12 + 4*rsi]
	xor	edx, dword ptr [r8 + 4*rdi]
	mov	ebx, r13d
	mov	eax, r13d
	movzx	esi, bh
	movzx	edi, bl
	...
	shr	eax, 16
	movzx	eax, al
	mov	r10d, dword ptr [r9 + 4*rax]
	xor	r10d, dword ptr [r14 + 4*rbx]
	xor	r10d, dword ptr [r12 + 4*rsi]
	xor	r10d, dword ptr [r8 + 4*rdi]
	mov	eax, ecx
	movzx	esi, ch
	movzx	edi, cl
                                        ## kill: def $ecx killed $ecx def $rcx
	...
	bswap	ebx
	xor	eax, ebx
	xor	edx, dword ptr [r11 + 116]
	xor	edx, eax
	xor	eax, dword ptr [r11 + 120]
	xor	ebx, dword ptr [r11 + 124]
	mov	r14, r11
	xor	ebx, r10d
	xor	eax, r15d
	shr	ecx, 24
	...
	shr	eax, 16
	movzx	eax, al
	mov	ebx, dword ptr [r13 + 4*rax]
	xor	ebx, dword ptr [r8 + 4*r15]
	xor	ebx, dword ptr [r12 + 4*rsi]
	xor	ebx, dword ptr [r9 + 4*rdi]
	xor	edx, ecx
	xor	ecx, ebx
	...
	ror	ebx, 16
	xor	r15d, ebx
	xor	edx, dword ptr [r14 + 132]
	xor	edx, r15d
	xor	r13d, dword ptr [r14 + 136]
	xor	ecx, dword ptr [r14 + 140]
	xor	r13d, r15d
	xor	ecx, ebx
	shr	eax, 24
	shr	esi, 16
	...
	xor	eax, ebx
	mov	r12, r14
	xor	edx, dword ptr [r14 + 148]
	xor	edx, eax
	xor	eax, dword ptr [r14 + 152]
	...
	ror	ebx, 16
	xor	r15d, ebx
	xor	edx, dword ptr [r12 + 164]
	xor	edx, r15d
	xor	r14d, dword ptr [r12 + 168]
	xor	ecx, dword ptr [r12 + 172]
	xor	r14d, r15d
	xor	ecx, ebx
	shr	eax, 24
	shr	esi, 16
	movzx	esi, sil
	mov	r10d, dword ptr [r11 + 4*rsi]
	xor	r10d, dword ptr [r9 + 4*rax]
	lea	r12, [rip + _X1]
	xor	r10d, dword ptr [r12 + 4*rdi]
	lea	r15, [rip + _X2]
	xor	r10d, dword ptr [r15 + 4*r13]
	mov	eax, edx
	movzx	esi, dh
	movzx	edi, dl
	mov	ebx, edx
	...
	bswap	r9d
	xor	ebx, r9d
	xor	edx, dword ptr [r8 + 180]
	xor	edx, ebx
	xor	ebx, dword ptr [r8 + 184]
	xor	r9d, dword ptr [r8 + 188]
	xor	r9d, eax
	mov	ecx, r9d
	xor	ebx, r10d
	shr	r13d, 24
	movzx	eax, byte ptr [r14 + 4*r13]
	...
	lea	r12, [rip + _S2]
	movzx	r10d, byte ptr [r12 + 4*r15]
	mov	byte ptr [r13 + 3], r10b
	shr	edx, 24
	movzx	edx, byte ptr [r14 + 4*rdx]
	...
	movzx	r10d, bl
                                        ## kill: def $ebx killed $ebx def $rbx
	movzx	esi, byte ptr [r9 + 4*rsi]
	mov	byte ptr [r13 + 6], sil
	movzx	esi, byte ptr [r12 + 4*rdi]
	mov	byte ptr [r13 + 7], sil
	shr	ebx, 24
	...
	movzx	eax, byte ptr [r9 + 4*rdx]
	mov	byte ptr [r13 + 10], al
	movzx	eax, byte ptr [r12 + 4*r10]
	mov	byte ptr [r13 + 11], al
	shr	ecx, 24
	movzx	eax, byte ptr [r14 + 4*rcx]
	mov	byte ptr [r13 + 12], al
	shr	edi, 16
	movzx	eax, dil
	movzx	eax, byte ptr [r11 + 4*rax + 1]
	mov	byte ptr [r13 + 13], al
	movzx	eax, byte ptr [r9 + 4*rsi]
	mov	byte ptr [r13 + 14], al
	movzx	eax, byte ptr [r12 + 4*rbx]
	mov	byte ptr [r13 + 15], al
	movdqu	xmm0, xmmword ptr [r13]
	movdqa	xmm1, xmmword ptr [r8 + 192]
	pshufb	xmm1, xmmword ptr [rip + LCPI0_0] ## xmm1 = xmm1[3,2,1,0,7,6,5,4,11,10,9,8,15,14,13,12]
	pxor	xmm1, xmm0
