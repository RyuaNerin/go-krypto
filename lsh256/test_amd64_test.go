...
func Test_LSH224_SSSE3(t *testing.T) {
	testAsm(t, testCases224, Size224, simdSetSSSE3, hasSSSE3)
}
func Test_LSH256_SSSE3(t *testing.T) {
	testAsm(t, testCases256, Size, simdSetSSSE3, hasSSSE3)
}

func Test_LSH224_AVX2(t *testing.T) {
	testAsm(t, testCases224, Size224, simdSetAVX2, hasAVX2)
}
func Test_LSH256_AVX2(t *testing.T) {
	testAsm(t, testCases256, Size, simdSetAVX2, hasAVX2)
}
