...
Operation
	...
	dst[MAX:256] := 0
*/
func _mm256_loadu_si256(dst, src Op) Op {
...
*/
func _mm256_storeu_si256(dst, src Op) Op {
	VMOVDQ_autoAU(src, dst)
	return dst
}
...
Operation
	...
	dst[MAX:256] := 0
*/
func _mm256_xor_si256(dst, a, b Op) Op {
	CheckType(
		`
		//	VPXOR m256 ymm ymm
		//	VPXOR ymm  ymm ymm
...
Operation
	...
	dst[MAX:256] := 0
*/
func _mm256_or_si256(dst, a, b Op) Op {
	CheckType(
		`
		//	VPOR m256 ymm ymm
		//	VPOR ymm  ymm ymm
...
Operation
	...
	dst[MAX:256] := 0
*/
func _mm256_and_si256(dst, a, b Op) Op {
	CheckType(
		`
		//	VPAND m256 ymm ymm
		//	VPAND ymm  ymm ymm
...
Operation
	...
	dst[MAX:256] := 0
*/
func _mm256_shuffle_epi8(dst, x, y Op) Op {
	CheckType(
		`
...
Operation
	...
	dst[MAX:256] := 0
*/
func _mm256_add_epi32(dst, a, b Op) Op {
	CheckType(
		`
		//	VPADDD m256 ymm ymm
		//	VPADDD ymm  ymm ymm
...
Operation
	...
	dst[MAX:256] := 0
*/
func _mm256_slli_epi32(dst, a, imm8 Op) Op {
	CheckType(
		`
		//	VPSLLD imm8 ymm  ymm
		//	VPSLLD m128 ymm  ymm
...
Operation
	...
	dst[MAX:256] := 0
*/
func _mm256_srli_epi32(dst, a, imm8 Op) Op {
	CheckType(
		`
		//	VPSRLD imm8 ymm  ymm
		//	VPSRLD m128 ymm  ymm
...
Operation
	...
	dst[MAX:256] := 0
*/
func _mm256_shuffle_epi32(dst, a, imm8 Op) Op {
	CheckType(
		`
...
Operation
	...
	dst[MAX:256] := 0
*/
func _mm256_permute2x128_si256(dst, a, b, imm8 Op) Op {
	CheckType(
		`
